...
#define BIND_OP(name, am, opcode, tacts, penalty) \
    ...
    BIND_OP(AND, ABS_X, 0x3D, 4, false)
    BIND_OP(AND, ABS_Y, 0x39, 4, false)
    BIND_OP(AND, IND_X, 0x21, 6, false)
    BIND_OP(AND, IND_Y, 0x31, 5, false)
    // ASL
    ...
    // Branches
    BIND_OP(BCC, DEF,   0x90, 2, false)
    BIND_OP(BCS, DEF,   0xB0, 2, false)
    BIND_OP(BEQ, DEF,   0xF0, 2, false)
    BIND_OP(BMI, DEF,   0x30, 2, false)
    BIND_OP(BNE, DEF,   0xD0, 2, false)
    BIND_OP(BPL, DEF,   0x10, 2, false)
    BIND_OP(BVC, DEF,   0x50, 2, false)
    BIND_OP(BVS, DEF,   0x70, 2, false)
    // BIT
    ...
    BIND_OP(CMP, ABS_X, 0xDD, 4, false)
    BIND_OP(CMP, ABS_Y, 0xD9, 4, false)
    BIND_OP(CMP, IND_X, 0xC1, 6, false)
    BIND_OP(CMP, IND_Y, 0xD1, 5, false)
    // CPX
    ...
    BIND_OP(EOR, ABS_X, 0x5D, 4, false)
    BIND_OP(EOR, ABS_Y, 0x59, 4, false)
    BIND_OP(EOR, IND_X, 0x41, 6, false)
    BIND_OP(EOR, IND_Y, 0x51, 5, false)
    // INC
    ...
    BIND_OP(ORA, IND_Y, 0x11, 5, false)
    // PHA
    ...
    BIND_OP(SBC, IND_Y, 0xF1, 5, false)
    // SEC
